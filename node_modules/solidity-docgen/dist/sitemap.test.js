...
ava_1.default('single readme', t => {
    ...
    const sitemap = sitemap_1.Sitemap.generate(source, dummyFilter, [emptyReadme()], 'md', false);
...
ava_1.default('filter subdirectory', t => {
    const source = buildSoliditySource(b => b
        ...
        .file('sub/Bar.sol')
        .contract('Bar'));
    const sitemap = sitemap_1.Sitemap.generate(source, dummyFilter, [emptyReadme('sub')], 'md', false);
    const { pages: [page] } = sitemap;
...
ava_1.default('links', t => {
    const source = buildSoliditySource(b => b
        ...
        .file('sub2/Foo.sol')
        .contract('Foo'));
    const sitemap = sitemap_1.Sitemap.generate(source, dummyFilter, [emptyReadme('sub1'), emptyReadme('sub2')], 'md', false);
